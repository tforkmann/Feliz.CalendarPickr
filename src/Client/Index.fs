...
[<ReactComponent>]
let Calendar (startDate, setStartDate) =

    DateRange.calendar [
        // calendar.months 1
        calendar.showSelectionPreview true
        calendar.moveRangeOnFirstSelection false
        calendar.direction Direction.Horizontal
        calendar.color "pink"
        calendar.locale DateTime.Locales.German
        calendar.onChange (fun date ->
            setStartDate date)
